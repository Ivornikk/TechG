...
const Categories = () => {
    ...
    return (
        <div className="self-start justify-self-start flex-shrink-0 flex flex-col relative">
            <div onClick={() => {setShown(!shown); setTypesShown(false)}} className="group md:translate-y-0 w-[195px] md:w-57 cursor-pointer flex bg-button rounded-lg p-1 flex-shrink-0">
