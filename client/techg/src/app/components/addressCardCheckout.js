...
const AddressCardCheckout = ({addresses}) => {
    ...
    useEffect(() => {
        setCurrentRegions(regions.filter(region => region.country === selectedCountry)[0].regions)
    }, [selectedCountry])
    ...
    return (
        <div className="flex justify-between px-20 py-7 flex-col shadow-xl bg-categories">
            <div className="w-full flex justify-between">
                ...
                { !addAddressShown && addresses.length < 4 &&
                ...
                <form className="w-full grid grid-cols-2 gap-10">
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            <input placeholder="First name"
                                className="border border-brand py-1 px-1"></input>
                    ...
                    <div className="mt-20 flex justify-end gap-5 px-10 text-xl">
                        <button className="px-10 py-3 border border-brand rounded-xl bg-brand text-white cursor-pointer hover:bg-categories hover:text-brand transition"
                            onClick={() => setAddAddressShown(false)}>
                            Cancel
                        </button>
                        <button className="px-10 py-3 border border-brand rounded-xl bg-brand text-white cursor-pointer hover:bg-categories hover:text-brand transition">
                            Add Address
